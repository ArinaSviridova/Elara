...
const TESTS = {
  ...
  pss10: {
    ...
    questions: [
      ...
      'Как часто ты чувствовал(а) нервозность и стресс?',
      'Как часто ты уверенно справлялся(ась) с личными проблемами?', // reverse
      ...
      'Как часто ты умел(а) контролировать раздражение?', // reverse
      'Как часто ты чувствовал(а), что держишь ситуацию под контролем?', // reverse
  ...
  who5: {
    ...
    questions: [
      'Я чувствовал(а) себя радостным(ой) и в хорошем расположении духа',
      'Я чувствовал(а) себя спокойным(ой) и расслабленной',
      'Я чувствовал(а) себя активным(ой) и энергичной',
      'Я просыпался(ась) бодрым(ой) и отдохнувшей',
